			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Seleccionar archivos") + '</div>' +
						'<div class="plupload_header_text">' + _("Agrega los archivos en la cola de subida, y hace clic en el boton de inicio.") + '</div>' +
						'<div class="plupload_view_switch">' +
							'<input type="radio" id="'+obj.id+'_view_list" name="view_mode_'+obj.id+'" checked="checked" /><label class="plupload_button" for="'+obj.id+'_view_list" data-view="list">' + _('Lista') + '</label>' +
							'<input type="radio" id="'+obj.id+'_view_thumbs" name="view_mode_'+obj.id+'" /><label class="plupload_button"  for="'+obj.id+'_view_thumbs" data-view="thumbs">' + _('Miniaturas') + '</label>' +
						'</div>' +
					'</div>' +
				'</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Nombre de Archivo') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('Estado') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('Peso') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Arrastra los archivos aqui.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Agregar archivos") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("Iniciar subida") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_("Detener subida") + '</a>&nbsp;' +
						'</div>' +
	...
	*/
	...
	_handleState: function() {
		...
		if (plupload.STARTED === up.state) {			
			...
			$('.plupload_upload_status', this.element).html(o.sprintf(_('Subidos %d/%d archivos'), up.total.uploaded, up.files.length));
	...
	_updateTotalProgress: function() {
		...
		this.element
			...
			.find('.plupload_upload_status')
				.html(o.sprintf(_('Subidos %d/%d archivos'), up.total.uploaded, up.files.length));
	},
